 /******************************************************************************
 *  Compilation:  javac QuickAndMergeSortPackage.StdIn.java
 *  Execution:    java QuickAndMergeSortPackage.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The <tt>QuickAndMergeSortPackage.StdIn</tt> class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!QuickAndMergeSortPackage.StdIn.hasNextChar()) {
 *      char c = QuickAndMergeSortPackage.StdIn.readChar();
 *      QuickAndMergeSortPackage.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (!QuickAndMergeSortPackage.StdIn.hasNextLine()) {
 *      String line = QuickAndMergeSortPackage.StdIn.readLine();
 *      QuickAndMergeSortPackage.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = QuickAndMergeSortPackage.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code QuickAndMergeSortPackage.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  Some of the main differences are summarized below:
 *  <ul>
 *  <li> {@code QuickAndMergeSortPackage.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code QuickAndMergeSortPackage.StdIn} uses whitespace as the delimiter between tokens.
 *  <li> {@code QuickAndMergeSortPackage.StdIn} coerces the character-set encoding to UTF-8,
 *       which is a standard character encoding for Unicode.
 *  <li> {@code QuickAndMergeSortPackage.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code QuickAndMergeSortPackage.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code QuickAndMergeSortPackage.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code QuickAndMergeSortPackage.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, <tt>QuickAndMergeSortPackage.StdIn</tt>
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to QuickAndMergeSortPackage.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to QuickAndMergeSortPackage.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to QuickAndMergeSortPackage.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to QuickAndMergeSortPackage.StdIn
    
    
    // do this once when QuickAndMergeSortPackage.StdIn is initialized
    static {
        resync();
    }

    /**
     * If QuickAndMergeSortPackage.StdIn changes, use this to reinitialize the scanner.
     */
